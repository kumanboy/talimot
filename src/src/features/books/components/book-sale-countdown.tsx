...
import styles from "./book-sale-countdown.module.css";

type BookSaleCountdownProps = {
...
function calculateRemainingTime(endsAt: string): RemainingTime {
...
export function BookSaleCountdown({
    endsAt,
}: BookSaleCountdownProps) {
    ...
    return (
        ...
        >
            <span className={styles.label}>Aksiya tugashiga</span>
